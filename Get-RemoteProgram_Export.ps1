...
Get-RemoteProgram -Property Publisher,InstallDate,DisplayVersion,InstallSource,IsMinorUpgrade,ReleaseType,ParentDisplayName,SystemComponent | Sort-Object ProgramName | Export-Csv -NoTypeInformation -Encoding Unicode -Delimiter ";" -Path \\emo.local\dfs\Admin\AdminInfo\$env:COMPUTERNAME-Software.csv
Get-RemoteProgram -Property Publisher,InstallDate,DisplayVersion,InstallSource,IsMinorUpgrade,ReleaseType,ParentDisplayName,SystemComponent | Sort-Object ProgramName | Export-Csv -NoTypeInformation -Encoding Unicode -Delimiter ";" -Path C:\install\AdminInfo\$env:COMPUTERNAME-Software.csv
